...
brazillianFoods = ["Coxinha", null, "Brigadeiro"];

// console.log(brazillianFoods);
...
brazillianFoods[1] = "Pão de Queijo";
...
const foodsInfo = `Até aqui, o array ${brazillianFoods} possui ${brazillianFoods.length} itens: ${brazillianFoods[0]}, ${brazillianFoods[1]} e ${brazillianFoods[2]}.`;
...
// console.log(`A ${dessert.replaceAll(" ", "")} é um doce à base de coco, tradicional na América Latina e em Angola.`);
